...
class UserClientInterface(QObject, Logger.ClassLogger, NetLayerLib.ClientAgent):
    ...
    def onFirstNotify(self):
        ...
        RCI.instance().login(  login=self.login, password=self.password, channelId=self.channelId  )
        # try:
    ...
    # def onAuthenticate (self, data):
        ...
        # responseCode, userRights, userId, available = data

        # updateClient, _, _ = available
        ...
        # elif responseCode == CODE_OK:
            ...
            # if updateClient == 200:
                ...
                # newMajor, newMinor, newFix =  available[1].split(".")
